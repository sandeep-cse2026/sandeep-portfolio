...
const SocialLinks = () => {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-semibold text-light-grey mb-8">
        Connect With Me
      </h2>
      ...
      <div className="space-y-6">
        ...
        <div className="pt-6 border-t border-light-grey/20">
          <h3 className="text-lg font-medium text-light-grey mb-4">
            Find Me On
          </h3>
        ...
        >
          <p className="text-light-grey/80">
            Prefer a quick chat? Feel free to reach out on any platform or send
            me an email. I&apos;m always interested in hearing about new
